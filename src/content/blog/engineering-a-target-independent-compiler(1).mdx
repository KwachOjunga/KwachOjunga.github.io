---
title: "Inside LLVM: Engineering a target independent Compiler - (1)"
date: "2026-09-16"
description: "Why LLVM Exists"
tags: ["Rust", "Systems", "Compilers"]
author: "Reginald Ojunga"
---

NOTE: This series follows the inside LLVM series i began my dev.to account.
I intend to complete the rest of it that covers the definition of the machine
independent representation here.
