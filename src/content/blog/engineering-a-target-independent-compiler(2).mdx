---
title: "Inside LLVM: Engineering a target independent Compiler - (2)"
date: "2026-09-16"
description: "LLVM IR: Designing a Universal Contract Between Languages and Machines"
...
A `Module` is the top-level container (roughly a compilation unit). It contains `Function`s. 
